...
emotionColors = {'negative': (159, 159, 255), 'positive': (0, 255, 255), 'neutral': (128, 128, 128)}
...
# # Slightly positive eyes (in progress)
# img = cv2.ellipse(img, left_center, left_axes, theta, 0, 180, (0, 0, 0), thickness=-1)
# img = cv2.ellipse(img, right_center, right_axes, theta, 0, 180, (0, 0, 0), thickness=-1)
